...
function buildTrip({ destination, days, tripType, travelers, budget, lang }) {
  ...
  return {
    destination: dest.name, slug: dest.slug, country: dest.country,
    region: dest.region, tripType, days, travelers, lang,
    transport: dest.transport || null, accommodation: dest.accommodation || [],
    itinerary: itin.days.slice(0, days), tags: itin.tags || [],
    estimatedCost: {
